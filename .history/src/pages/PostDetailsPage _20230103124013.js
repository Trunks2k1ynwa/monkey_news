...
import { collection,doc,getDoc,onSnapshot,where,query } from "firebase/firestore"
...
const PostDetailsPage = () => {
  ...
  async function fetchUserData () {
    const docRef = doc(db,"users",postInfo.user.id);
      ...
      <Layout>
        <div className="container">
          ...
          <div className="post-content">
            ...
            <AuthorBox userIdd={postInfo.user.id}></AuthorBox>
          </div>
