    ...
    <SignUpPageStyles>
      ...
      <form action="" className="form" onSubmit={handleSubmit(handleSignUp)}>
        ...
        <Field>
          ...
          >
            {showIconEye?<IconEyeOpen onClick={()=>setShowIconEye(!showIconEye)} type={true} className="icon-eye"></IconEyeOpen>:<IconEyeClose onClick={()=>setShowIconEye(!showIconEye)} type={true} className="icon-eye"></IconEyeClose>}
          </Input>
        </Field>
      </form>
    </SignUpPageStyles>
