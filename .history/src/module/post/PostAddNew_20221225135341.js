...
import { query, collection, getDocs,addDoc,serverTimestamp  } from "firebase/firestore";
          ...
          <Field>
            ...
            <Dropdown>
              <Dropdown.Select placeholder="Select the category">
                ...
                {selectCategory?.name && <span className="inline-block p-3 mt-1 text-sm font-medium bg-green-200 rounded-lg color-green">{selectCategory?.name}</span>}
          </Field>
        </div>
