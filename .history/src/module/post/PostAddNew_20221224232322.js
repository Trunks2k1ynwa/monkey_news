          ...
          <Field>
            ...
            <Dropdown>
              <Dropdown.Select placeholder="Select the category">
                ...
                <span className="inline-block p-3 text-sm font-medium bg-green-200 rounded-lg color-green">{selectCategory.name}</span>
                {selectCategory && <span>{selectCategory}</span>}
            </Dropdown>
          </Field>
        </div>
