...
const PostAddNew = () => {
  async function getJSONAsync() {
    let json = await axios.get('http://levantrung.great-site.net/ListUsers.php');
    return json;
}
console.log(getJSONAsync())
const a = axios.get('http://levantrung.great-site.net/ListUsers.php')
      .then(res => {
