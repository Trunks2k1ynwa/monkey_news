        ...
        <div className="form-layout">
          ...
          <Field>
            ...
            <FieldCheckboxes>
              ...
              <Radio name="role" control={control} checked={Number(watchRole)===userRole.MOD}  value={userStatus.MOD}>
                Moderator
              </Radio>
              <Radio name="role" control={control} checked={Number(watchRole)===userRole.USER}  value={userStatus.USER}>
                User
              </Radio>
              <Radio name="role" control={control} checked={Number(watchRole)===userRole.EDITOR}  value={userStatus.EDITOR}>
                Editor
              </Radio>
            </FieldCheckboxes>
          </Field>
