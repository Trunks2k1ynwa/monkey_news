...
const CategoryManage = () => {
  ...
  useEffect(() => {
    ...
    const newRef = filter ? query(colRef, where("name",">=",filter),where("name","<=",filter)):colRef;
  ...
  return (
    <div>
      ...
      <div className="relative Search">
        <span onClick={handleFind} className="absolute top-3 left-3 text-lg text-[#00D1ED] fa-solid fa-magnifying-glass cursor-pointer"></span>
        <input id="input-search" className="w-[300px] p-3 pl-12 rounded border-2 border-[#00D1ED]" placeholder="Enter your keyword" type="text" />
      </div>
      </DashboardHeading>
      <Table>
        <thead>
