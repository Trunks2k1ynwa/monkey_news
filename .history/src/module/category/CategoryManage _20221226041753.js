...
const CategoryManage = () => {
  ...
  return (
    <div>
      ...
      <Button onClick={handleFind} kind="ghost" height="60px" to="/manage/add-category">
          Create category
        </Button>
      <div className="Search relative">
        <span className="absolute top-3 left-3 text-lg text-[#00D1ED] fa-solid fa-magnifying-glass cursor-pointer"></span>
        <input onChange={handleFilter} className="w-[300px] p-3 pl-12 rounded border-2 border-[#00D1ED]" placeholder="Enter your keyword" type="text" />
      </div>
      </DashboardHeading>
      <Table>
        <thead>
