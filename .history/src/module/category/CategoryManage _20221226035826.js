  ...
  return (
    <div>
      ...
      <div className="Search relative">
        <span className="absolute fa-solid fa-magnifying-glass cursor-pointer"></span>
        <input className="p-3 pl-6 rounded border-2 border-secondary" placeholder="Enter your keyword" type="text" />
      </div>
      <Table>
        <thead>
          <tr>
