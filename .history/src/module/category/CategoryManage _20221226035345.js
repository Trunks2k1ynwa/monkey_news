  ...
  return (
    <div>
      ...
      <div className="Search">
        <span className="fa-solid fa-magnifying-glass cursor-pointer"></span>
        <input className="p-3 pl-5 rounded border border-green-100" placeholder="Enter your keyword" type="text" />
      </div>
      <Table>
        <thead>
          <tr>
