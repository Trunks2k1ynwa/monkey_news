...
const ImageUpload = (props) => {
  ...
  useEffect(() =>{
    setArrProgress(prev=>[...prev,progress])
  },[progress])
  console.log(arrProgress)
  return (
    <label
      className={`cursor-pointer flex items-center justify-center border border-dashed w-full h-[300px] rounded-lg ${className} relative overflow-hidden group`}
    >
      <input
        type="file"
        name={name}
